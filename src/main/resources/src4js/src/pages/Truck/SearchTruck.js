...
class UpdateForm extends PureComponent {
  ...
  constructor(props) {
    ...
    this.state = {
      formVals: {
        truckNumber: props.values.truckNumber,
  ...
  renderContent = (currentStep, formVals) => {
    ...
    return [
      <FormItem key="truckNumber" {...this.formLayout} label="车牌">
        {form.getFieldDecorator('truckNumber', {
          rules: [{ required: true, message: '请输入车牌！' }],
          initialValue: formVals.truckNumber,
        })(<Input placeholder="请输入" />)}
      </FormItem>,
      <FormItem key="driver" {...this.formLayout} label="驾驶员">
        {form.getFieldDecorator('driver', {
          rules: [{ required: true, message: '请输入至少五个字符的驾驶员！', min: 5 }],
          initialValue: formVals.driver,
