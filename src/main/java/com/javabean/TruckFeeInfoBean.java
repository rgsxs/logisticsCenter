...
public class TruckFeeInfoBean {
	
	public TruckFeeInfoBean(){}
	
	public TruckFeeInfoBean(String carryNumber,String truckNumber,BigDecimal expensens,BigDecimal oilCost,BigDecimal towinigCost,BigDecimal roadCost,BigDecimal repairCost,BigDecimal leadWayCost,BigDecimal tireCost,BigDecimal otherCost,BigDecimal allowance){
